...
export const awesomeShadcn: AwesomeShadcnItem[] = [
  ...
  },
  {
    ...
    title: "Neobrutalism",
    description:
      "Collection of neobrutalism-styled Tailwind components. A distinct aesthetic for standout marketing and content.tsx layouts.",
  ...
  },
  {
    ...
    title: "Landing",
    description:
      "Landing page template emphasizing community, resources, tutorials, and support. Mobile-friendly and customizable (colors, fonts, images) with social proof, targeted content.tsx, strong visuals, and clear CTAs.",
  ...
  },
  {
    ...
    description:
      "A modern, feature-rich Learning Management System built with Next.js 15, Sanity CMS, Clerk, and Stripe. Features real-time content.tsx updates, course progress tracking, and secure payment processing.",
